...
<template>
  <div class="min-h-full w-full">
    ...
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div
        v-if="loading"
        class="w-full bg-white border border-slate-200 rounded-2xl p-8 text-center text-slate-500"
      >
      ...
      <div
        v-else-if="loadError"
        class="w-full bg-white border border-red-200 rounded-2xl p-8 text-center"
      >
